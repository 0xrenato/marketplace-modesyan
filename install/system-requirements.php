                                ...
                                <div class="row">
                                    <div class="col-sm-11">
                                        ...
                                        <p>
                                            ...
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You need to enable "cURL" on your server)</small></strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                            ...
                                            <?php if (extension_loaded('fileinfo')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You need to enable "Fileinfo" on your server)</small></strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            ...
                                            <?php if (extension_loaded('mbstring')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You need to enable "mbstring" PHP extension on your server)</small></strong>
                                            <?php endif; ?>
                                        </p>
                                        <p>
                                            ...
                                            <?php if (extension_loaded('gd')): ?>
                                                <strong class="color-success">Enabled</strong>
                                            <?php else: ?>
                                                <strong class="color-danger">Disabled&nbsp;<small>(You need to enable "gd" PHP extension on your server)</small></strong>
                                            <?php endif; ?>
                                        </p>
